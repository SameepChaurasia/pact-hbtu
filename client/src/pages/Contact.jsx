...
<div className= "basis-1/3 pt-4 pl-4 pr-10 text-base md:text-xl">
    ...
    <div className="text-center pt-5">
            <a className="font-serif font-bold text-5xl underline decoration-emerald-800">CONTACT</a>
          </div><br/>

          <a className="font-serif font-bold text-base md:text-3xl">DR. ARUN MAITHANI</a><br/>
          <a className="font-serif font-bold text-base md:text-xl">Professor & Head</a><br/>
          <a className="font-serif font-bold text-base md:text-xl">Department of Chemical Technology – Paint Technology</a><br/><br/>

          <a className="font-serif font-bold text-base md:text-xl">Phone: 7081300524</a><br/>

          <a className="font-serif font-bold text-base md:text-xl">Email: hodpt@hbtu.ac.in</a><br/>

          <div className="flex justify-center items-center"><img src="contactsection.jpeg" /></div>
